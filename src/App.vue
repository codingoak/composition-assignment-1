<template>
  ...
  <h3 v-if="courseData.isVisible">{{ courseData.goal }}</h3>
...
// function toggleGoal() {
//   courseData.value.isVisible = !courseData.value.isVisible;
// }
// *****************************************************************
...
// function toggleGoal() {
//   courseData.isVisible = !courseData.isVisible;
// }
</script> -->
...
export default {
  ...
  methods: {
    toggleGoal() {
      this.courseData.isVisible = !this.courseData.isVisible;
    },
  },
};
</script>
